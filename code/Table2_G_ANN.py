...
DETAIL_FILE  = RESULTS_DIR / f"Table2_G_ANN{RANGE_TAG}_detail.csv"
SUMMARY_FILE = RESULTS_DIR / f"Table2_G_ANN{RANGE_TAG}_summary.csv"
...
def run():
    ...
    print(f"[INFO] Starting G_ANN — {n_targets} targets x {len(TEST_YEARS)} years", flush=True)
