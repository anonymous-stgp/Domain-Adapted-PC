...
DETAIL_FILE  = RESULTS_DIR / f"Table2_TF_XGBoost_detail{SETUP_SUFFIX}{year_suffix}.csv"
SUMMARY_FILE = RESULTS_DIR / f"Table2_TF_XGBoost_summary{SETUP_SUFFIX}{year_suffix}.csv"
...
def run():
    ...
    print(f"[INFO] Starting TF_XGBoost (DFP) — {n_targets} targets x {len(TEST_YEARS)} years", flush=True)
