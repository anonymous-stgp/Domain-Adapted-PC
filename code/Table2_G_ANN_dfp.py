...
DETAIL_FILE  = RESULTS_DIR / f"Table2_G_ANN_detail{SETUP_SUFFIX}.csv"
SUMMARY_FILE = RESULTS_DIR / f"Table2_G_ANN_summary{SETUP_SUFFIX}.csv"
...
def run():
    ...
    print(f"[INFO] Starting G_ANN (DFP) — {n_targets} targets x {len(TEST_YEARS)} years", flush=True)
